...
//Lesson
	contentArray.push("This is one of the trickiest topics in the grammar section, since people casually default to who ~100% of the time. Your grammatical ear might not work perfectly here: even when you use whom correctly, it might still sound a little bit off.<br><br>Who is a subject pronoun, while whom is an object pronoun. <br><br>Who serves the same purpose as I, she, he, we, and they.<br><br>As a subject pronoun, who is used for the person or people performing the verb. <br>")
	...
	contentArray.push("Since who serves the same purpose as the other subject pronouns, you can often test whether or not who works in a sentence by replacing it with, say, she.<br><br>Who is coming over to study for the test?<br><br>She is coming over .to study for the test.<br><br>Who wants to skip the study group and cover the teacher's car in Post-It notes instead?<br><br>She wants to skip the study group and cover the teacher's car in Post-It notes instead.<br><br>If you can replace \"who\" with \"she\" and the sentence still makes sense, then you know that \"who\" is the correct pronoun.")
...
//Test for multiple choice
	...
	contentArray.push("There are now a bunch of options to choose?! Fun!<br><br> <form><input type='radio' id='0' name='mc'><label for='0'>First Choice</label><br><input type='radio' id='1' name='mc'><label for='1'>Not 1st Choice</label><br><input type='radio' id='2' name='mc'><label for='2'>Worst Choice</label> </form> ");
